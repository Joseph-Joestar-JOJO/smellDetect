...
public class Bug implements java.io.Serializable{
	...
	private String body;
	private it.unisa.bsic.bean.Commit fix;
	private String product;
	private String component;
	private String assignedTo;
	private String status;
	private String resolution;
	private List<it.unisa.bsic.bean.Commit> fixInducingChanges;
	...
	public it.unisa.bsic.bean.Commit getFix() {
		return fix;
	}
	public void setFix(it.unisa.bsic.bean.Commit fix) {
		this.fix = fix;
	}
	public List<it.unisa.bsic.bean.Commit> getFixInducingChanges() {
